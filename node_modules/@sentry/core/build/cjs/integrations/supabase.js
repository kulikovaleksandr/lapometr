...
function instrumentAuthOperation(operation, isAdmin = false) {
  return new Proxy(operation, {
    apply(target, thisArg, argumentsList) {
      ...
      const name = client && hasSpanStreamingEnabled.hasSpanStreamingEnabled(client) ? (
      ...
      return trace.startSpanManual(
        {
          ...
          attributes: {
            ...
            [attributes.SENTRY_OP]: op.DB,
            [attributes.DB_SYSTEM_NAME]: "postgresql",
            [attributes.DB_OPERATION_NAME]: operationName
          }
        },
        (span) => {
  ...
  PostgRESTFilterBuilder.prototype.then = new Proxy(
    PostgRESTFilterBuilder.prototype.then,
    {
      apply(target, thisArg, argumentsList) {
        ...
        const name = client && hasSpanStreamingEnabled.hasSpanStreamingEnabled(client) ? `${operation}${table ? ` ${table}` : ""}` : description;
        const attributes$1 = {
          "db.table": table,
        ...
        if (queryItems.length && shouldSendData) {
          attributes$1["db.query"] = queryItems;
        }
        if (bodyPayload !== void 0 && shouldSendData) {
          attributes$1["db.body"] = bodyPayload;
        }
        return trace.startSpanManual(
          {
            name,
