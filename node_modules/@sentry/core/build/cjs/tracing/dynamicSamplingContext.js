...
function getDynamicSamplingContextFromScope(client, scope) {
  if (currentScopes.getExternalPropagationContext()) {
    return void 0;
  }
...
function getDynamicSamplingContextFromSpan(span) {
  ...
  const rootSpanJson = spanUtils.spanToStaticSpanJSON(rootSpan);
  ...
  const source = rootSpanAttributes[attributes.SENTRY_SEGMENT_NAME_SOURCE];
