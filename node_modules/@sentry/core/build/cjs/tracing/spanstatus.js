...
const spanStatus = require('../types/spanStatus.js');

const SPAN_STATUS_UNSET = 0;
const SPAN_STATUS_OK = 1;
const SPAN_STATUS_ERROR = 2;
function isStatusErrorMessageValid(message) {
  return message !== "ok" && spanStatus.SPAN_STATUS_TYPES.includes(message);
}
...
exports.isStatusErrorMessageValid = isStatusErrorMessageValid;
