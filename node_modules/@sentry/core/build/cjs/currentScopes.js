...
function registerExternalPropagationContext(fn) {
  carrier.getSentryCarrier(carrier.getMainCarrier()).externalPropagationContextProvider = fn;
}
function getExternalPropagationContext() {
  return carrier.getSentryCarrier(carrier.getMainCarrier()).externalPropagationContextProvider?.();
}
function hasExternalPropagationContext() {
  return carrier.getSentryCarrier(carrier.getMainCarrier()).externalPropagationContextProvider !== void 0;
}
