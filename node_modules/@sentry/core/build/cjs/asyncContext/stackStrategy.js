...
const constants = require('../tracing/constants.js');
...
function suppressTracingInStack(callback) {
  return withScope((scope) => {
    scope.setSDKProcessingMetadata({ [constants.SUPPRESS_TRACING_KEY]: true });
    const res = callback();
    scope.setSDKProcessingMetadata({ [constants.SUPPRESS_TRACING_KEY]: void 0 });
    return res;
  });
}
