...
class ServerRuntimeClient extends client.Client {
  ...
  constructor(options) {
    ...
    if ((typeof __SENTRY_TRACING__ === "undefined" || __SENTRY_TRACING__) && options.traceLifecycle !== "static" && !options.integrations.some((i) => i.name === spanStreaming.INTEGRATION_NAME)) {
