...
import type { JsonRpcError, MCPTransport, RequestId, ResolvedMcpOptions } from './types';
/**
 ...
 */
export declare function completeSpanWithResults(transport: MCPTransport, requestId: RequestId, result: unknown, error?: JsonRpcError): void;
/**
