...
export interface SentryCarrier {
    ...
    externalPropagationContextProvider?: () => {
        traceId: string;
        spanId: string;
    } | undefined;
 ...
 */
export declare function getGlobalSingleton<Prop extends keyof SentryCarrier>(name: Prop, creator: () => NonNullable<SentryCarrier[Prop]>, obj?: import(".").InternalGlobal): NonNullable<SentryCarrier[Prop]>;
export {};
