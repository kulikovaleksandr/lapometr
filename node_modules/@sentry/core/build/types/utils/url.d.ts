 ...
 */
export declare function getUrlQuery(query: string | undefined): string | undefined;
/**
 ...
 * unconditionally — setting an attribute to `undefined` is a no-op.
 */
export declare function getUrlFragment(fragment: string | undefined): string | undefined;
/**
 ...
 */
export declare function getUrlDomain(url: string, base?: string): string | undefined;
type PartialRequest = {
    method?: string;
};
/**
