 ...
 */
export declare function httpHeadersToSpanAttributes(headers: Record<string, string | string[] | undefined>, dataCollection: ResolvedDataCollection, lifecycle?: 'request' | 'response'): Record<string, string[]>;
/** Formats cookie pairs as `name=value` span attribute values, with sensitive values replaced. */
export declare function filterCookiePairs(cookies: CookiePair[], cookieBehavior: CollectBehavior): string[];
 ...
 */
export declare function getContentLengthFromHeaders(headers: Record<string, string | string[] | undefined>): number | undefined;
