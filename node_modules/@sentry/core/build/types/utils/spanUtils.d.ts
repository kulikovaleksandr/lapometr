 ...
 */
export declare function spanToStaticSpanJSON(span: Span): SpanJSON;
/**
 * Convert a span to a JSON representation.
 */
export declare function spanToJSON(span: Span): StreamedSpanJSON;
/**
...
export declare function getStatusMessage(status: SpanStatus | undefined): string;
/**
 ...
 */
export declare function spanIsSegment(span: SpanWithPotentialChildren): boolean;
/**
 ...
 */
export declare function INTERNAL_setSegmentNameSourceIfSegment(span: Span, source: TransactionSource): void;
export {};
