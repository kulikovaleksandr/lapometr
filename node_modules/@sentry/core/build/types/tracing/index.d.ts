...
export { setCapturedScopesOnSpan, getCapturedScopesOnSpan, markSpanAsTracerProviderSpan, spanIsTracerProviderSpan, } from './utils';
...
export { setHttpStatus, getSpanStatusFromHttpCode, isStatusErrorMessageValid, SPAN_STATUS_ERROR, SPAN_STATUS_OK, SPAN_STATUS_UNSET, } from './spanstatus';
export { continueTrace, withActiveSpan, suppressTracing, isTracingSuppressed, startNewTrace, spanIsIgnored, } from './trace';
