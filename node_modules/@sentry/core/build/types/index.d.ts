...
export { withStaticSpan, withStreamedSpan, } from './tracing/spans/beforeSendSpan';
...
export { convertSpanLinksForEnvelope, spanToTraceHeader, spanToStaticSpanJSON, spanToJSON, spanIsSampled, spanIsSentrySpan, spanToTraceContext, getSpanDescendants, getStatusMessage, getRootSpan, INTERNAL_getSegmentSpan, getActiveSpan, addChildSpanToSpan, spanTimeInputToSeconds, updateSpanName, INTERNAL_setSegmentNameSourceIfSegment, } from './utils/spanUtils';
...
export { winterCGHeadersToDict, winterCGRequestToRequestData, captureBodyFromWinterCGRequest, httpRequestToRequestData, extractQueryParamsFromUrl, headersToDict, httpHeadersToSpanAttributes, getContentLengthFromHeaders, getMaxBodyByteLength, MAX_BODY_BYTE_LENGTH, } from './utils/request';
...
export { addItemToEnvelope, createAttachmentEnvelopeItem, createEnvelope, createEventEnvelopeHeaders, envelopeContainsItemType, envelopeItemTypeToDataCategory, forEachEnvelopeItem, getSdkMetadataForEnvelopeHeader, parseEnvelope, serializeEnvelope, } from './utils/envelope';
...
export { getSanitizedUrlString, parseUrl, stripUrlQueryAndFragment, parseStringToURLObject, getHttpSpanDetailsFromUrlObject, isURLObjectRelative, getSanitizedUrlStringFromUrlObject, stripDataUrlContent, getUrlQuery, getUrlFragment, getUrlDomain, } from './utils/url';
...
export type { Context, Contexts, DeviceContext, OsContext, AppContext, CultureContext, TraceContext, CloudResourceContext, } from './types/context';
...
export type { AttachmentItem, BaseEnvelopeHeaders, BaseEnvelopeItemHeaders, ClientReportEnvelope, ClientReportItem, DynamicSamplingContext, Envelope, EnvelopeItemType, EnvelopeItem, EventEnvelope, EventEnvelopeHeaders, EventItem, ReplayEnvelope, FeedbackItem, SessionEnvelope, SessionItem, UserFeedbackItem, CheckInItem, CheckInEnvelope, RawSecurityEnvelope, RawSecurityItem, ProfileItem, ProfileChunkEnvelope, ProfileChunkItem, StreamedSpanEnvelope, LogEnvelope, MetricEnvelope, } from './types/envelope';
...
export type { CollectBehavior, DataCollection, HttpBodyCollectionTarget, HttpHeadersCollection, ResolvedDataCollection, } from './types/datacollection';
...
export type { DurationUnit, InformationUnit, FractionUnit, MeasurementUnit, MetricUnit, NoneUnit, Measurements, } from './types/measurement';
...
export type { BuildTimeOptionsBase, ModuleMetadata, ModuleMetadataCallback, ModuleMetadataCallbackArgs, ReactComponentAnnotationOptions, ResolveSourceMapHook, } from './build-time-plugins/buildTimeOptionsBase';
