...
export declare abstract class Client<O extends ClientOptions = ClientOptions> {
     ...
     * @returns {() => void} A function that, when executed, removes the registered callback.
     */
    on(hook: 'prepareSpanScope', callback: (spanScope: {
        scope: Scope;
    ...
    on(hook: 'beforeIdleSpanEnd', callback: (idleSpan: Span) => void): () => void;
    /**
     ...
     */
    on(hook: 'preprocessSpan', callback: (streamedSpanJSON: StreamedSpanJSON) => void): () => void;
    /**
     ...
     * @returns {() => void} A function that, when executed, removes the registered callback.
     */
    on(hook: 'afterEnvelope', callback: (envelope: Envelope) => void): () => void;
    /**
     ...
     * @returns {() => void} A function that, when executed, removes the registered callback.
     */
    on(hook: 'flushTraceSpans', callback: (traceId: string) => void): () => void;
    /**
     ...
     * @returns {() => void} A function that, when executed, removes the registered callback.
     */
    on(hook: 'orchestrion.module-injected', callback: (moduleName: string) => void): () => void;
    ...
    emit(hook: 'prepareSpanScope', spanScope: {
        scope: Scope;
        parentSpan: Span | undefined;
    }): void;
    ...
    emit(hook: 'beforeIdleSpanEnd', idleSpan: Span): void;
    /**
     ...
     */
    emit(hook: 'preprocessSpan', streamedSpanJSON: StreamedSpanJSON): void;
    /**
     ...
     */
    emit(hook: 'afterEnvelope', envelope: Envelope): void;
    /**
     ...
     */
    emit(hook: 'flushTraceSpans', traceId: string): void;
    /**
     ...
     */
    emit(hook: 'orchestrion.module-injected', moduleName: string): void;
    /**
