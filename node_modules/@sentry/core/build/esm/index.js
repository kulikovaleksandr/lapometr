...
export { getCapturedScopesOnSpan, markSpanAsTracerProviderSpan, setCapturedScopesOnSpan, spanIsTracerProviderSpan } from './tracing/utils.js';
export { TRACING_DEFAULTS } from './tracing/idleSpan.js';
...
export { SPAN_STATUS_ERROR, SPAN_STATUS_OK, SPAN_STATUS_UNSET, getSpanStatusFromHttpCode, isStatusErrorMessageValid, setHttpStatus } from './tracing/spanstatus.js';
export { continueTrace, isTracingSuppressed, spanIsIgnored, startInactiveSpan, startNewTrace, startSpan, startSpanManual, suppressTracing, withActiveSpan } from './tracing/trace.js';
...
export { GEN_AI_CONVERSATION_ID_ATTRIBUTE, SEMANTIC_ATTRIBUTE_CACHE_HIT, SEMANTIC_ATTRIBUTE_CACHE_ITEM_SIZE, SEMANTIC_ATTRIBUTE_CACHE_KEY, SEMANTIC_ATTRIBUTE_EXCLUSIVE_TIME, SEMANTIC_ATTRIBUTE_HTTP_REQUEST_METHOD, SEMANTIC_ATTRIBUTE_PROFILE_ID, SEMANTIC_ATTRIBUTE_SENTRY_CUSTOM_SPAN_NAME, SEMANTIC_ATTRIBUTE_SENTRY_ENVIRONMENT, SEMANTIC_ATTRIBUTE_SENTRY_IDLE_SPAN_FINISH_REASON, SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_UNIT, SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE, SEMANTIC_ATTRIBUTE_SENTRY_OP, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, SEMANTIC_ATTRIBUTE_SENTRY_PREVIOUS_TRACE_SAMPLE_RATE, SEMANTIC_ATTRIBUTE_SENTRY_RELEASE, SEMANTIC_ATTRIBUTE_SENTRY_SAMPLE_RATE, SEMANTIC_ATTRIBUTE_SENTRY_SDK_INTEGRATIONS, SEMANTIC_ATTRIBUTE_SENTRY_SDK_NAME, SEMANTIC_ATTRIBUTE_SENTRY_SDK_VERSION, SEMANTIC_ATTRIBUTE_SENTRY_SEGMENT_ID, SEMANTIC_ATTRIBUTE_SENTRY_SEGMENT_NAME, SEMANTIC_ATTRIBUTE_SENTRY_STATUS_MESSAGE, SEMANTIC_ATTRIBUTE_URL_FULL, SEMANTIC_ATTRIBUTE_USER_EMAIL, SEMANTIC_ATTRIBUTE_USER_ID, SEMANTIC_ATTRIBUTE_USER_IP_ADDRESS, SEMANTIC_ATTRIBUTE_USER_USERNAME, SEMANTIC_LINK_ATTRIBUTE_LINK_TYPE } from './semanticAttributes.js';
export { BROWSER_NAVIGATION_TIMING_SPAN_NAMES, CACHE_OPERATION_NAMES, DB_SPAN_NAME_FALLBACK, FUNCTION_SPAN_NAME_FALLBACK, GEN_AI_AGENT_SPAN_NAME_FALLBACK, GEN_AI_INFERENCE_SPAN_NAME_FALLBACK, GRAPHQL_SPAN_NAME_FALLBACK, HTTP_SPAN_NAME_FALLBACK, MCP_NOTIFICATION_SPAN_NAME_FALLBACK, MCP_SERVER_SPAN_NAME_FALLBACK, MESSAGING_SPAN_NAME_FALLBACK, NAVIGATION_SPAN_NAME_FALLBACK, PAGELOAD_SPAN_NAME_FALLBACK, REQUEST_HANDLER_SPAN_NAME_FALLBACK, RESOURCE_SPAN_NAME_FALLBACK, ROUTER_SPAN_NAME_FALLBACK, SERVERLESS_FUNCTION_SPAN_NAME_FALLBACK, UI_ACTION_CLICK_SPAN_NAME_FALLBACK, UI_ACTION_SPAN_NAME_FALLBACK, UI_INTERACTION_CLICK_SPAN_NAME_FALLBACK, UI_INTERACTION_DRAG_SPAN_NAME_FALLBACK, UI_INTERACTION_HOVER_SPAN_NAME_FALLBACK, UI_INTERACTION_PRESS_SPAN_NAME_FALLBACK, UI_LONG_TASK_SPAN_NAME_FALLBACK, UI_MOUNT_SPAN_NAME_FALLBACK, UI_RENDER_SPAN_NAME_FALLBACK, UI_RESOLVE_SPAN_NAME_FALLBACK, UI_SPAN_NAME_FALLBACK, UI_TASK_SPAN_NAME_FALLBACK, UI_UNMOUNT_SPAN_NAME_FALLBACK, UI_UPDATE_SPAN_NAME_FALLBACK, UI_WEBVITAL_CLS_SPAN_NAME_FALLBACK, UI_WEBVITAL_LCP_SPAN_NAME_FALLBACK } from './tracing/spans/spanNames.js';
...
export { waitForTracingChannelBinding } from './asyncContext/tracing-channel-binding.js';
...
export { getVercelEnv } from './utils/vercel.js';
...
export { withStaticSpan, withStreamedSpan } from './tracing/spans/beforeSendSpan.js';
export { isSentryRequestUrl } from './utils/isSentryRequestUrl.js';
export { handleCallbackErrors } from './utils/handleCallbackErrors.js';
export { safeCallback } from './utils/safeCallback.js';
export { fmt, parameterize } from './utils/parameterize.js';
export { handleTunnelRequest } from './utils/tunnel.js';
export { addAutoIpAddressToSession } from './utils/ipAddress.js';
export { INTERNAL_getSegmentSpan, INTERNAL_setSegmentNameSourceIfSegment, addChildSpanToSpan, convertSpanLinksForEnvelope, getActiveSpan, getRootSpan, getSpanDescendants, getStatusMessage, spanIsSampled, spanIsSentrySpan, spanTimeInputToSeconds, spanToJSON, spanToStaticSpanJSON, spanToTraceContext, spanToTraceHeader, updateSpanName } from './utils/spanUtils.js';
...
export { matchesTracePropagationTargets, shouldPropagateTraceForUrl } from './utils/tracePropagationTargets.js';
...
export { MAX_BODY_BYTE_LENGTH, captureBodyFromWinterCGRequest, extractQueryParamsFromUrl, getContentLengthFromHeaders, getMaxBodyByteLength, headersToDict, httpHeadersToSpanAttributes, httpRequestToRequestData, winterCGHeadersToDict, winterCGRequestToRequestData } from './utils/request.js';
export { DEFAULT_ENVIRONMENT, DEV_ENVIRONMENT } from './constants.js';
export { spanKindToName } from './spanKind.js';
export { addBreadcrumb } from './breadcrumbs.js';
export { functionToStringIntegration } from './integrations/functiontostring.js';
export { eventFiltersIntegration } from './integrations/eventFilters.js';
...
export { addItemToEnvelope, createAttachmentEnvelopeItem, createEnvelope, createEventEnvelopeHeaders, envelopeContainsItemType, envelopeItemTypeToDataCategory, forEachEnvelopeItem, getSdkMetadataForEnvelopeHeader, parseEnvelope, serializeEnvelope } from './utils/envelope.js';
...
export { getHttpSpanDetailsFromUrlObject, getSanitizedUrlString, getSanitizedUrlStringFromUrlObject, getUrlDomain, getUrlFragment, getUrlQuery, isURLObjectRelative, parseStringToURLObject, parseUrl, stripDataUrlContent, stripUrlQueryAndFragment } from './utils/url.js';
...
export { warnOnRemovedBuildOptions } from './build-time-plugins/warnOnRemovedBuildOptions.js';
