...
import { INTEGRATION_NAME, spanStreamingIntegration } from './integrations/spanStreaming.js';
...
class ServerRuntimeClient extends Client {
  ...
  constructor(options) {
    ...
    if ((typeof __SENTRY_TRACING__ === "undefined" || __SENTRY_TRACING__) && options.traceLifecycle !== "static" && !options.integrations.some((i) => i.name === INTEGRATION_NAME)) {
