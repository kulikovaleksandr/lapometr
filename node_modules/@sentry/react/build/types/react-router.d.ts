...
export { wrapReactRouterRouting, wrapCreateBrowserRouter, wrapCreateMemoryRouter, wrapUseRoutes, } from './reactrouter.compat';
 ...
 */
export declare function reactRouterBrowserTracingIntegration(options?: BrowserTracingOptions & Partial<ReactRouterOptions>): Integration;
