...
import type { Action, AgnosticDataRouteMatch, CreateRouterFunction, CreateRoutesFromChildren, Location, MatchRoutes, ReactRouterConfig, RouteObject, Router, RouterState, UseEffect, UseLocation, UseNavigationType, UseRoutes } from '../types';
 ...
 */
export declare function processResolvedRoutes(resolvedRoutes: RouteObject[], config: ReactRouterConfig, parentRoute?: RouteObject, currentLocation?: Location | null, capturedSpan?: Span): void;
/**
 * Updates a navigation span with the correct route name after lazy routes have been loaded.
 */
export declare function updateNavigationSpan(activeRootSpan: Span, location: Location, allRoutes: RouteObject[], forceUpdate: boolean | undefined, config: ReactRouterConfig): void;
/**
