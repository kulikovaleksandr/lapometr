 ...
 */
export declare function rebuildRoutePathFromAllRoutes(allRoutes: RouteObject[], location: Location, matchRoutes: MatchRoutes): string;
/**
 * Checks if the current location is inside a descendant route (route with splat parameter).
 */
export declare function locationIsInsideDescendantRoute(location: Location, routes: RouteObject[], matchRoutes: MatchRoutes): boolean;
/**
 * Gets a normalized route name and transaction source from the current routes and location.
 */
export declare function getNormalizedName(routes: RouteObject[], location: Location, branches: RouteMatch[], basename?: string, stripBasename?: boolean): [string, TransactionSource];
/**
 * Shared helper function to resolve route name and source
 */
export declare function resolveRouteNameAndSource(location: Location, routes: RouteObject[], allRoutes: RouteObject[], branches: RouteMatch[], config: ReactRouterConfig): [string, TransactionSource];
/**
