...
function sendIndexPath(pathBuilder, pathname, basename, stripBasename) {
  const reconstructedPath = pathBuilder && pathBuilder.length > 0 ? pathBuilder : stripBasename ? stripBasenameFromPathname(pathname, basename) : pathname;
  let formattedPath = (
